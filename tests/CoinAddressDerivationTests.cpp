...
TEST(Coin, DeriveAddress) {
    ...
    //
    // EXPECT_EQ(TW::deriveAddress(TWCoinTypeBitcoin44, privateKey), "bc1qhkfq3zahaqkkzx5mjnamwjsfpq2jk7z00ppggv");
    //
    ...
    //
    // EXPECT_EQ(TW::deriveAddress(TWCoinTypeLitecoin44, privateKey), "ltc1qhkfq3zahaqkkzx5mjnamwjsfpq2jk7z0tamvsu");
    //
